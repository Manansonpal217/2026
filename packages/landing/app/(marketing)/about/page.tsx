    ...
    <main className="min-h-screen">
      ...
      <section className="border-t border-border px-4 py-16 sm:px-6 sm:py-28">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Link
            href="/contact"
            className="mt-8 inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-primary to-accent px-6 py-3 font-medium text-primary-foreground shadow-lg shadow-primary/25 transition-all hover:shadow-primary/40"
          >
...
function ValueCard({
  ...
  return (
    <div className="rounded-xl border border-border bg-card/70 p-6 backdrop-blur-sm transition-all hover:border-border">
